...
user4.chatrooms << chatroom1

Message.create!(body: 'Hello', read_status: true, user_id: user1.id, chatroom_id: chatroom1.id)
Message.create!(body: 'Hey!', read_status: false, user_id: user4.id, chatroom_id: chatroom1.id)
Message.create!(body: 'Whats up?', read_status: true, user_id: user1.id, chatroom_id: chatroom1.id)
Message.create!(body: 'Not much just hanging out, you?', read_status: false, user_id: user4.id, chatroom_id: chatroom1.id)
Message.create!(body: 'Just waiting for Bruce to come back', read_status: true, user_id: user1.id, chatroom_id: chatroom1.id)
Message.create!(body: 'Oh whos that?', read_status: false, user_id: user4.id, chatroom_id: chatroom1.id)
...
Message.create!(body: 'That sounds very cool, what do you do in this cave?', read_status: false, user_id: user4.id, chatroom_id: chatroom1.id)
...
Message.create!(body: 'I love that movie!', read_status: false, user_id: user4.id, chatroom_id: chatroom1.id)

chatroom2 = Chatroom.create!(active_status: true)
user1.chatrooms << chatroom2
user5.chatrooms << chatroom2

Message.create!(body: 'Room #2!', read_status: true, user_id: user5.id, chatroom_id: chatroom2.id)
Message.create!(body: 'Room 2 Buddies!', read_status: true, user_id: user1.id, chatroom_id: chatroom2.id)
Message.create!(body: 'Yea!', read_status: true, user_id: user5.id, chatroom_id: chatroom2.id)
